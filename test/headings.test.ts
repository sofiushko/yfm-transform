...
describe('Headings', () => {
    ...
    test('should skip till reaching level 2', () => {
        expect(getHeadings(tokenize(['#### Level 4', '## Level 2']), true)).toEqual([
            item('Level 2', 2),
        ]);
    });

    test('should skip all levels', () => {
        expect(getHeadings(tokenize(['### Level 3 (1)', '### Level 3 (2)']), true)).toEqual([]);
    });
    ...
    test('should not skip levels on needFilterHeadings false', () => {
        expect(
            ...
            item('Level 1 (1)', 1, [
                item('Level 3 (1)', 3, [item('Level 5 (1)', 5)]),
                item('Level 3 (2)', 3, [
                    item('Level 5 (2)', 5),
                    item('Level 5 (3)', 5, [item('Level 6 (1)', 6)]),
                ]),
                item('Level 4 (1)', 4),
            ]),
            item('Level 2 (1)', 2),
